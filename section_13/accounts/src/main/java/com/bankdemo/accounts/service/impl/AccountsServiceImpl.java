...
import com.bankdemo.accounts.dto.AccountsMsgDto;
...
import com.bankdemo.accounts.exception.CustomerAlreadyExistsException;
...
public class AccountsServiceImpl  implements IAccountsService {
    ...
    // TODO 10 add class to produce the events. This allows the user to send data to an output binding
    ...
    private void sendCommunication(Accounts account, Customer customer) {
        ...
        var result = streamBridge.send("sendCommunication-out-0", accountsMsgDto);// send() produces the event
     ...
     */
    @Override
    public boolean updateCommunicationStatus(Long accountNumber) { // message MS will send the accountNumber
        boolean isUpdated = false;
